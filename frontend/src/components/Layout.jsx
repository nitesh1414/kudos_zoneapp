...
/** Administrators can point every market tab at any tracked symbol. */
function SymbolSwitcher() {
  ...
  return (
    <label className="hidden items-center gap-2 rounded-xl bg-white/5 py-1.5 pr-2 pl-3 ring-1 ring-white/10 md:flex">
