...
function ClientForm({ mode, form, setForm, brokers, error }) {
  ...
  return (
    <div className="space-y-3.5">
      ...
      <Field label="Market symbol" hint="Pick a tracked symbol or type any exact provider symbol.">
        <Input value={form.symbol} onChange={set('symbol')} placeholder="NSE:NIFTY50-INDEX" list="tracked-symbols" required />
